        ...
        <div class="col-md-2">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    @if(
                        $baseDato->firma 
                        && Storage::disk('public')->exists($baseDato->firma)
                    )
                    <div class="mb-3">
                        <p class="text-success font-semibold">✅ Firma registrada</p>
                        <!-- Imagen de la firma que abre el modal al hacer clic -->
                        <img 
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="firmaModalLabel">Firma Registrada</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <!-- Imagen de la firma en el modal -->
                <img src="{{ Storage::url($baseDato->firma) }}" alt="Firma actual" class="img-fluid">
            </div>
        </div>
    </div>
</div>