            ...
            <div class="card-body">
                <div class="row" style="display: flex; justify-content: flex-end; align-items: center;">
                    <div class="col-md-12" style="background-color: rgb(90, 128, 158);color:white; display: flex; justify-content: flex-end; align-items: center; padding-top: 5px;">
                        <label style="font-weight: bold; font-size: 18px;">Total Puestos: <span style="font-weight: normal;">{{$totales->puestos}}</span></label>
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            @foreach ($zonas as $zona)
                                <tr style="text-align: center" onclick="getMesasDePuesto({{$zona->Dpt}},{{$zona->Mpio}},{{$zona->Zona}},{{$zona->Pto}},'{{ $zona->Puesto }}')">
                                    {{-- <td>{{ ++$i }}</td> --}}
