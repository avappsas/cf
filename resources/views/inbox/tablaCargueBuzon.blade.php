 ...
 <table id="tablaDocss" class="table table-striped table-hover" name="tablaDocs">
    ...
    <tbody>
        @foreach($datos as $dato)
            @php
  $nombreArchivo = Str::slug($nombreContratista ?? 'nombre') . '-' . Str::slug($dato->Nombre ?? 'formato') . '.pdf';
            ...
            <tr class="tr-principal">
                ...
                <td>
                    @switch($dato->Estado)
                        ...
                        @case('(SI APLICA)')
                            ...
                            @break
                        @case('CARGADO') @case('APROBADA') @case('FIRMADO')
                ...
                <td>
                            ...
                            <a class="btn btn-sm btn-danger"
                                onclick="AbrirPDFM('{{ $dato->Ruta }}', '{{ $dato->idContrato }}', '{{ $dato->idCuota }}', '{{ $nombreArchivo }}')">
