<table id="tablaDocss" class="table table-striped table-hover" name="tablaDocs">
 ...
 @if(isset($contrato)  && $contrato->Estado = 'RPC - Aprobado')
<div class="modal-footer">
    <a class="btn btn-md btn-success" onclick="cambioEstadoContrato(1, {{ isset($dato) ? $dato->idContrato : 'null' }})" style="margin-right: 3px" id="btnAprobar">   <i class="fa-solid fa-file-circle-check" ></i> Poner en Ejecución</a>
</div>
 @endif
