            ...
            $outputPath = 'C:\laragon\www\cf\public\documentos/documento_65d7999db933d4.30923302.docx'
        ...
        $copiedTemplatePath = 'C:\laragon\www\cf\public\documentos/copia_documento_65d7999db93441.02983221.docx'
        ...
        $document.Content.Find.Execute('<<V_fecha_cuenta>>', $false, $false, $false, $false, $false, $true, 1, $false, '30/11/2022')
        $document.Content.Find.Execute('<<V_CC>>', $false, $false, $false, $false, $false, $true, 1, $false, '1144028976')
        $pdfOutputPath = 'C:\laragon\www\cf\public\documentos/documento_65d7999db933d4.30923302.docx.pdf'
